...
<div class="sidebar">
  ...
  <a href="livestock.php"><i class="fa fa-paw me-2"></i> Livestock</a>
  <a href="product.php"><i class="fa fa-box me-2"></i> Products</a>
  <a href="location.html"><i class="fa fa-map-marker-alt me-2"></i> Locations</a>
  <a href="order.html"><i class="fa fa-shopping-cart me-2"></i>Protein</a>
  <a href="farmer_dashboard.php"><i class="fa fa-lightbulb me-2"></i> Recommended </a>
...
<div class="topbar bg-dark text-white">
  ...
  <div>
    <img src="img/user4.jpg" alt="User"class="rounded-circle me-2" style="width:40px;"> Annana
  </div>
</div>
