...
<!-- Sidebar -->
<div class="sidebar">
  <a href="index.php"><h3 style="color:red; font-weight:bold;">MEAT KING</h3></a>
  <a class="active" href="admin.php"><i class="fas fa-tachometer-alt me-2"></i>Historical production data </a>
  <a href="livestock.php"><i class="fas fa-cow me-2"></i> Livestock</a>
  <a href="product.html"><i class="fas fa-box-open me-2"></i> Products</a>
  <a href="location.html"><i class="fas fa-map-marked-alt me-2"></i> Locations</a>
  <a href="order.html"><i class="fas fa-shopping-basket me-2"></i> Orders</a>
  <a href="nutritionist.php"><i class="fas fa-apple-alt me-2"></i> Recommendation</a>
  <a href="login.php"><i class="fas fa-sign-out-alt me-2"></i> Logout</a>
</div>


<!-- Topbar -->
<div class="topbar" style="background-color: black; color: white; padding: 10px; display: flex; justify-content: space-between; align-items: center;">
...
<div class="content" id="mainContent">
  ...
  <form method="POST" class="row g-3 mb-3">
    ...
    <div class="col-md-3"><input type="text" name="area" class="form-control" placeholder="Area (e.g., 5 acres)" required></div>
  ...
  <table class="table table-bordered">
    <thead class="table-light">
      <tr><th>Yield</th><th>Livestock</th><th>Cost</th><th>Proessing data</th><th>Actions</th></tr>
    </thead>
    <tbody>
    <?php
