...
<!-- Sidebar -->
<div class="sidebar">
    <a href="admin.php"><h3 style="color:red; font-weight:bold;">MEAT KING</h3></a>
    <a href="consumer.php" class="active"><i class="fa fa-home me-2"></i> Dashboard</a>
...
<div class="topbar bg-dark text-white">
    ...
    <div>
        <img src="img/user18.jpg" alt="User" class="rounded-circle me-2" style="width:40px;"> Dibyo
    </div>
</div>
...
<div class="content" id="mainContent">
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-3"><a href="cart.php" class="card-box text-decoration-none"><h6>Add to Cart</h6><h3><i class="fa fa-shopping-cart"></i></h3></a></div>
